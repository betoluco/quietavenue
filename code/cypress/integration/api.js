describe('API', () =>{
    it('API returns complete objects', () =>{
        cy.request('/api/estates').then(
            (response) => {
                ...
                expect(response.body[1].profilePicture).to.contain('assets/1023-Flying-Fish-St-94404/Front.jpg')
                ...
                expect(response.body[1].graphData[0].mp3Link).to.contain('assets/1023-Flying-Fish-St-94404/audioFiles/2020-08-13_15-42-00.mp3')
            }
        )
    });
    ...
    //         expect(resp.body).to.deep.equal('id', '2141-Mills-Ave-Menlo-Park-CA-94025')
    //     });
    // });
});
