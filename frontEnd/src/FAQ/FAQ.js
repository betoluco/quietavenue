         ...
         <div className="">
            ...
            <div className="w-full flex flex-col items-center mb-8 py-12 bg-stone-200">
                <div className="px-3 max-w-screen-md">
                    <h4 className="mb-3 text-lg sm:text-xl  text-stone-800 font-semibold">Is it legal to record audio and video outside the property?</h4>
                    ...
                    <h4 className="mb-3 text-lg sm:text-xl  text-stone-800 font-semibold">Does QuietAvenue needs access to the property?</h4>
                    ...
                    <h4 className="mb-3 text-lg sm:text-xl  text-stone-800 font-semibold">Does the property need to be uninhabited?</h4>
                    ...
                    <h4 className="mb-3 text-lg sm:text-xl  text-stone-800 font-semibold">Do I need to provide power or Wi-fi access?</h4>
                    ...
                    <h4 className="mb-3 text-lg sm:text-xl  text-stone-800 font-semibold">Do I need to be a real state professional to request my property to be displayed in QuietAvenue?</h4>
                    ...
                    <h4 className="mb-3 text-lg sm:text-xl  text-stone-800 font-semibold">What regions do you cover?</h4>
                    <p className='mb-6 text-base text-stone-800'>Currently we are limited to properties in the San Francisco Bay Area.</p>
                    <h4 className="mb-3 text-lg sm:text-xl  text-stone-800 font-semibold">How much does your service cost?</h4>
