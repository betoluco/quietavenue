...
it('link should have href', () =>{
    ...
    expect(screen.getByRole('link').href).toMatch('http://localhost:3000/estate/2/CA/-Foster-City/2141-Mills-Ave');
});

it('Image should have src', () =>{
    render(<Card estate={estate} />, {wrapper:BrowserRouter});
    expect(screen.getByRole('img').src).toMatch('http://localhost:3000/assets/2141-Mills-Ave-Foster-City-CA-9440/2141-Mills-Ave-Foster-City-CA-94404-main-pic.jpg');
});
